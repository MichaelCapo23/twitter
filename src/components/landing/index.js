				...
				<div className="landing-left-container">
					<div className="left-list-container">
						<div className="landing-logo-container">
							<div className="landing-list-container landing-list-first">
								<div className="landing-hover-container landing-list-first">
									<svg viewBox="60 0 24 30" className="twitter-logo">
										<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="home-logo">
									<g>
								...
								<div className="landing-list-text">Home</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="hastag-logo">
									<g>
								...
								<div className="landing-list-text">Explore</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="notifications-logo">
									<g>
								...
								<div className="landing-list-text">Notifications</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="messages-logo">
									<g>
								...
								<div className="landing-list-text">Messages</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="bookmark-logo">
									<g>
								...
								<div className="landing-list-text">Bookmarks</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="lists-logo">
									<g>
								...
								<div className="landing-list-text">Lists</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
							<svg viewBox="5 -3 24 30" className="profile-logo">
									<g>
								...
								<div className="landing-list-text">Profile</div>
							</div>
						</div>
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" className="more-logo">
									<g>
