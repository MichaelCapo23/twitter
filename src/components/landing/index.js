					...
					<div className="left-list-container">
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="home-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="hastag-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="notifications-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="messages-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="bookmark-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="lists-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="profile-logo">
									<g>
										<path d="M19.75 2H4.25C3.013 2 2 3.013 2 4.25v15.5C2 20.987 3.013 22 4.25 22h15.5c1.237 0 2.25-1.013 2.25-2.25V4.25C22 3.013 20.987 2 19.75 2zM11 16.75H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h4c.414 0 .75.336.75.75s-.336.75-.75.75zm6-4H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10c.414 0 .75.336.75.75s-.336.75-.75.75zm0-4H7c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h10c.414 0 .75.336.75.75s-.336.75-.75.75z"></path>
									</g>
								</svg>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container">
								<svg viewBox="5 -3 24 30" class="more-logo">
									<g>
						...
						<div className="landing-list-container">
							<div className="landing-hover-container"></div>
						</div>
					</div>
				</div>
